...
extern struct isakmp_payload *new_isakmp_payload(uint8_t type);
extern struct isakmp_payload *new_isakmp_data_payload(uint8_t type,
	const void *data, size_t data_length);
extern struct isakmp_attribute *new_isakmp_attribute(uint16_t type,
	struct isakmp_attribute *next);
extern struct isakmp_attribute *new_isakmp_attribute_16(uint16_t type,
	uint16_t data, struct isakmp_attribute *next);
...
extern struct isakmp_payload *parse_isakmp_payload(uint8_t type,
